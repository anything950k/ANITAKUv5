          ...
          <div className="flex items-center gap-3 mb-2.5">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-3.5 rounded-2xl bg-[#141419]/80 border border-white/10 text-sm text-white placeholder-neutral-400 focus:outline-none focus:border-[#c084fc] transition-colors shadow-lg"
              />
              {searchInput && (
                <button
                  onClick={() => {
